...
export class TableView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, cellMinWidth: number) {
    ...
    updateColumns(node, this.colgroup, this.dom, cellMinWidth);
  ...
  update(node: ProseMirrorNode) {
    ...
    this.node = node;
    updateColumns(node, this.colgroup, this.dom, this.cellMinWidth);
  ...
  ignoreMutation(mutation: ViewMutationRecord) {
    return (
      ...
      && (mutation.target === this.dom || this.colgroup.contains(mutation.target))
    );
  }
}
