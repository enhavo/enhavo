        ...
        <form-form :form="userManger.loginForm" v-if="userManger.loginForm" class="login-form" :key="userManger.loginForm.key">
            ...
            <div class="form-row">
                <div class="input-container">
                    ...
                    <router-link :to="{name: 'enhavo_user_admin_reset_password_request'}" class="reset-pw-link">{{ translator.trans('enhavo_user.reset_password.request.submit', null, 'javascript') }}</router-link>
