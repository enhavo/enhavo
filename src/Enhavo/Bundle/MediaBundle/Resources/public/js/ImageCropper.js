/**
 * Created by fliebl on 2016-06-07
 */

function ImageCropper(routing, uploadForm, admin) {
  var self = this;
  ...
  this.startImageCrop = function(selected, callbackDone, callbackCanceled) {
    if (typeof selected != 'undefined' && selected != null) {
      ...
      self.$cropperCanvas.attr('src', routing.generate(self.imageShowRoute, { id: fileId, v: preventCachingNumber }));
