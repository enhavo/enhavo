...
class EmailFormLoginAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
    ...
    /**
     * EmailFormLoginAuthenticator constructor.
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository($this->className)->findOneBy(['email' => $credentials['email']]);
