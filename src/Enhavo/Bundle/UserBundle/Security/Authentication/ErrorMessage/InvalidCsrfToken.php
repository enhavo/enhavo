...
class InvalidCsrfToken implements ErrorMessageInterface
{
    ...
    {
        return $error instanceof InvalidCsrfTokenException;
    }

    public function getMessage(): string
    {
        return $this->translator->trans('login.error.invalid_csrf_token', [], 'EnhavoUserBundle');
    }
}
