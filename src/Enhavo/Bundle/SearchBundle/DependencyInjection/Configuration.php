                ...
                ->arrayNode('elastic')
                    ...
                    ->children()
                        ...
                        ->arrayNode('fuzzy')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('fuzziness')->defaultValue('AUTO')->end()
                                ->scalarNode('max_expansions')->defaultValue(50)->end()
                                ->scalarNode('prefix_length')->defaultValue(0)->end()
                                ->scalarNode('transpositions')->defaultValue(true)->end()
                                ->scalarNode('rewrite')->defaultValue('constant_score_blended')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
