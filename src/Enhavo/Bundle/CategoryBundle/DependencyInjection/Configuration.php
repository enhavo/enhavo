                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('form')->defaultValue('Enhavo\Bundle\CategoryBundle\Form\Type\CollectionType')->cannotBeEmpty()->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('form')->defaultValue('Enhavo\Bundle\CategoryBundle\Form\Type\CategoryType')->cannotBeEmpty()->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
