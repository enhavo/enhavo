                    ...
                    ->children()
                        ->arrayNode('newsletter')
                            ...
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Enhavo\Bundle\AppBundle\Controller\NewsletterController')->end()
                        ...
                        ->arrayNode('subscriber')
                            ...
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Enhavo\Bundle\AppBundle\Controller\SubscriberController')->end()
