                ...
                ->arrayNode('newsletter')
                    ...
                    ->children()
                        ...
                        ->arrayNode('template')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('base')->defaultValue('EnhavoNewsletterBundle:Theme:base.html.twig')->end()
                                ->scalarNode('show')->defaultValue('EnhavoNewsletterBundle:Theme:showNewsletter.html.twig')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
