                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
                                            ->children()
                                                ->scalarNode('default')->defaultValue('Enhavo\Bundle\SliderBundle\Form\Type\SliderType')->cannotBeEmpty()->end()
                                            ->end()
                                        ->end()
                                    ->end()
                                ->end()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
                                            ->children()
                                                ->scalarNode('default')->defaultValue('Enhavo\Bundle\SliderBundle\Form\Type\SlideType')->cannotBeEmpty()->end()
                                            ->end()
                                        ->end()
                                    ->end()
                                ->end()
