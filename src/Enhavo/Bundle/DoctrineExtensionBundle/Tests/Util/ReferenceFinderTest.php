...
use Enhavo\Bundle\DoctrineExtensionBundle\Util\ReferenceFinder;

class ReferenceFinderTest extends DoctrineTest
{
    ...
    {
        $finder = new ReferenceFinder($this->em);
        ...
        $references = $finder->findReferencesTo($file);
