                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('controller')->defaultValue('Enhavo\Bundle\WorkflowBundle\Controller\NodeController')->end()
                                        ->scalarNode('repository')->end()
                                        ->scalarNode('factory')->defaultValue('Sylius\Component\Resource\Factory\Factory')->end()
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('controller')->defaultValue('Enhavo\Bundle\WorkflowBundle\Controller\TransitionController')->end()
                                        ->scalarNode('repository')->end()
                                        ->scalarNode('factory')->defaultValue('Sylius\Component\Resource\Factory\Factory')->end()
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
