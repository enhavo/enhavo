...
class Reference extends BaseReference implements SearchIndexInterface
{
     ...
     * Add services
     *
     * @param \esperanto\CategoryBundle\Entity\Category $services
     * @return Reference
     */
    public function addService(\esperanto\CategoryBundle\Entity\Category $services)
    {
     ...
     * @param \esperanto\CategoryBundle\Entity\Category $services
     */
    public function removeService(\esperanto\CategoryBundle\Entity\Category $services)
    {
