...
export class Media
{
    ...
    private initUploadButton()
    {
        ...
        this.$element.find('[data-media-input]').on('change', (event) => {
            ...
            let $formElement = jQuery(document.createElement("form"));
            $formElement.hide();
            ...
            jQuery('body').append($formElement.get(0));
    ...
    {
        jQuery(window).on('dragenter dragover', () => {
            this.$element.addClass('highlight');
        });

        jQuery(window).on('dragleave', () => {
    ...
    protected addFile(file: any)
    {
        ...
        let $element = jQuery(jQuery.parseHTML(prototype));
