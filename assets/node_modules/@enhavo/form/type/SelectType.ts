...
export default class SelectType extends FormType
{
    protected init()
    {
        ...
        if (jQuery.fn.select2.locales.hasOwnProperty(locale)) {
            jQuery.extend(jQuery.fn.select2.defaults, jQuery.fn.select2.locales[locale]);
        }
                ...
                onUpdate: () => {
                    ...
                    this.$element.children().each((index, element) => {
                        ...
                        if(beforeElement != element) {
                            jQuery(beforeElement).after(element);
                        }
                    });
                },
                onEnd: () => {
