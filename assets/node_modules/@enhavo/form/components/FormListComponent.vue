        ...
        <slot name="list">
            <ul>
                <draggable
                    ...
                    item-key="name"
                    @change="form.helper.changeOrder(event)"
                ...
                >
                    <template #item="{ element }">
                        <component
                            ...
                            @delete="form.helper.deleteItem(event)"
                            @up="form.helper.moveItemUp(event)"
                            @down="form.helper.moveItemDown(event)"
                        >
                            <template v-slot>
                                <slot name="item"></slot>
                            </template>
...
import {FormListHelper} from "@enhavo/form/helper/FormListHelper";
