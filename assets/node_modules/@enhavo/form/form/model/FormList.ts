...
export class FormList extends Form
{
    ...
    constructor(
        ...
        protected formEventDispatcher: FormEventDispatcher,
    ) {
        super();
    }
    ...
    public deleteItem(child: Form)
    {
        ...
        this.formEventDispatcher.dispatchEvent(event, 'delete')
    ...
    private createItem()
    {
        ...
        this.formEventDispatcher.dispatchEvent(event, 'create')
        return event.form;
    }
    ...
    {
        this.formEventDispatcher.dispatchEvent(new MoveEvent(item), 'beforeMove')
        ...
        this.formEventDispatcher.dispatchEvent(new MoveEvent(item), 'move')
    }
    ...
    public changeOrder(event: any)
    {
        ...
        this.updatePosition();
        if (event.moved) {
            this.formEventDispatcher.dispatchEvent(new MoveEvent(event.moved.element), 'move')
        } else if (event.added) {
            this.formEventDispatcher.dispatchEvent(new MoveEvent(event.added.element), 'move')
        }
    }
