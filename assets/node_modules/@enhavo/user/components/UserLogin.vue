<template>
    <form-form :form="userManger.loginForm" v-if="userManger.loginForm">
        ...
        <div class="form-row">
            <div class="input-container">
                ...
                <a href="" class="reset-pw-link">reset_password.request.submit</a>
        ...
        <div class="button-row">
            ...
            <button class="btn login-button" type="submit" id="_submit" name="_submit" @click.prevent="userManger.login()">security.login.submit</button>
        </div>
