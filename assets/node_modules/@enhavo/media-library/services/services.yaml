...
services:
    ...
    '@enhavo/media-library/components/FileRow.vue':
        chunk: 'vue'
        static: true
        tags:
            - { name: vue.component, component: 'file-row' }

    '@enhavo/media-library/components/FileThumbnail.vue':
        chunk: 'vue'
        static: true
        tags:
