...
import Data, {Item, Tab} from "@enhavo/media-library/Data";
...
export default class MediaLibraryApp
{
    ...
    private getList()
    {
        ...
        // let url = this.router.generate('enhavo_coconut_box_list');
        let url = '/admin/media-library/list';
        ...
        axios
            ...
            .then(response => {
                ...
                for(let itemData of itemsData) {
                    let item = new Item();
                    item.id = itemData.Id;
                    item.previewImageUrl = itemData.Preview.small;
                    item.tab = this.data.activeTab;
                    item.name = itemData.OriginalName;
                    item.selected = false;
                    items.push(item);
                }
