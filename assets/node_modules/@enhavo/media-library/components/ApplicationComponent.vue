    ...
    <div class="app-view">
        ...
        <div class="MediaLibrary-overlay" data-MediaLibrary-overlay>
            ...
            <div class="inner-content" data-scroll-container>
                <div class="tag-list">
                    <div class="headline"><i class="icon icon-folder_open"></i> Kategorien</div>
                    <tag-list
                        :categories="$MediaLibrary.data.categories"
                        :parents="[]"
                    ></tag-list>
                </div>
    ...
    export default class ApplicationComponent extends Vue
    {
        ...
        getAddLabel()
        {
            if(this.$MediaLibrary.data.multiple){
                return "Ausgewählte Bilder hinzufügen";
            } else {
                return "Ausgewähltes Bild hinzufügen";
            }
        }
