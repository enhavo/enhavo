    ...
    <div class="app-view">
        ...
        <div class="MediaLibrary-overlay" data-MediaLibrary-overlay>
            ...
            <div class="inner-content" data-scroll-container>
                <div class="tag-list">
                    <div class="headline"><i class="icon icon-filter_list"></i> Tags</div>
                    <tag-list
                        :tags="$MediaLibrary.data.tags"
                    ></tag-list>

                    <div class="headline"><i class="icon icon-filter_list"></i> Content-Types</div>
                    <content-type-list
    ...
    export default class ApplicationComponent extends Vue
    {
        ...
        getAddLabel()
        {
            if(this.$MediaLibrary.data.multiple){
                return "Ausgewählte Bilder hinzufügen"; // todo: translate
            } else {
                return "Ausgewähltes Bild hinzufügen"; // todo: translate
            }
        }
