                ...
                <div class="result-search">
                    ...
                    <div v-if="!mediaLibrary.data.loading">
                        <div class="media-library-view-switch">
                            <i class="icon icon-account_box" @click="setView('thumbnail')"></i>
                            <i class="icon icon-format_list_bulleted" @click="setView('list')"></i>
                        </div>
                        <pagination v-if="mediaLibrary.data.pages.length>1"></pagination>
