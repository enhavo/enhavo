            ...
            <div class="inner-content" data-scroll-container>
                ...
                <div class="result-search">
                    ...
                    <div v-if="!mediaLibrary.data.loading">
                        ...
                        <div v-if="mediaLibrary.data.pages.length>1" class="media-library-pagination">
                            <ul>
                                <li v-for="page in mediaLibrary.data.pages" @click="onClickPage(page)" :class="{'active':page===mediaLibrary.data.page}">
                                    {{ page }}
                                </li>
                            </ul>
                        </div>
...
@Options({
    components: {ThumbnailView, ListView}
})
