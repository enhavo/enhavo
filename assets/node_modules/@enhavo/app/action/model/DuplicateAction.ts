    ...
    execute(): void
    {
        this.view.confirm(new Confirm(
            ...
            () => {
                ...
                let queryParam = new URLSearchParams(uri.search);
                queryParam.set('view_id', this.view.getId().toString());
                let event = new LoadingEvent(this.view.getId());
                this.eventDispatcher.dispatch(event);
                jQuery('<form method="post" action="'+uri.toString()+'"><input type="hidden" name="_csrf_token" value="'+this.token+'"/></form>').appendTo('body').submit();
            },
            () => {
