...
export default class FormDispatcher
{
    public static dispatchMove(element: HTMLElement)
    {
        ...
        jQuery('body').trigger('formMove', event);
        return event;
    }
    ...
    {
        let event = new FormElementEvent(element);
        jQuery('body').trigger('formDrop', event);
        return event;
    }
    ...
    public static dispatchConvert(element: string)
    {
        ...
        jQuery('body').trigger('formConvert', event);
        return event;
    }
    ...
    public static dispatchInsert(element: HTMLElement)
    {
        ...
        jQuery('body').trigger('formInsert', event);
        return event;
    }
    ...
    public static dispatchRelease(element: HTMLElement)
    {
        ...
        jQuery('body').trigger('formRelease', event);
        return event;
    }
    ...
    {
        let event = new FormElementEvent(element);
        jQuery('body').trigger('formRemove', event);
        return event;
    }
}
