...
export default class FormListener
{
    ...
    {
        jQuery('body').on('formConvert', function(event, formEvent: FormConvertEvent) {
            callback(formEvent);
        });
    }
    ...
    {
        jQuery('body').on('formInsert', function(event, formEvent: FormInsertEvent) {
            callback(formEvent);
        });
    }
    ...
    {
        jQuery('body').on('formRelease', function(event, formEvent: FormReleaseEvent) {
            callback(formEvent);
        });
    }
    ...
    {
        jQuery('body').on('formMove', function(event, formEvent: FormElementEvent) {
            callback(formEvent);
        });
    }
    ...
    {
        jQuery('body').on('formDrop', function(event, formEvent: FormElementEvent) {
            callback(formEvent);
        });
    }
    ...
    {
        jQuery('body').on('formRemove', function(event, formEvent: FormElementEvent) {
            callback(formEvent);
        });
    }
}
