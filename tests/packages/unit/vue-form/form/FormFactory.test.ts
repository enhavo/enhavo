...
import {TestVisitor} from "../mock/TestVisitor";
import {Theme} from "@enhavo/vue-form/form/Theme";
import {TestForm} from "../mock/TestForm";
import {FormVisitor} from "@enhavo/vue-form/form/FormVisitor";
import {Form} from "@enhavo/vue-form/model/Form";
import {SomeFormModel, SomeService} from "../mock/SomeFormModel";
...
describe('on create ', () => {
    ...
    test('it should create a root form object', () => {
...
describe('on create with registered models', () => {
    ...
    test('it should create form with registered model', () => {
        let data = {
    ...
    test('it should create form with registered model and child', () => {
...
describe('After adding some visitors', () => {
    ...
    test('it should create a manipulate form with visitor parameter', () => {
    ...
    test('it should execute visitors only once', () => {
    ...
    test('it should create a manipulate form with visitor array', () => {
        let form = <TestForm>factory.create({component: 'test'}, [new TestVisitor('world', 70)]);
        assert.equal('world', form.testValues[3]);
    });

    test('it should create a manipulate form with theme parameter', () => {
        let form = <TestForm>factory.create({component: 'test'}, new Theme([new TestVisitor('world', 70)]));
        assert.equal('world', form.testValues[3]);
    });

    test('it should store the visitors in the root node', () => {
        let form = <TestForm>factory.create({component: 'test'}, new TestVisitor('world', 70));
        assert.equal(4, (form.getRoot()).visitors.length);
    });

    test('it should store the visitors only once at the root node', () => {
...
describe('After adding some visitors that replace a form', () => {
    ...
    test('it should be really replaced', () => {
...
describe('On create with form tree', () => {
    ...
    test('it should set the correct parents', () => {
        let form = <TestForm>factory.create(data);
