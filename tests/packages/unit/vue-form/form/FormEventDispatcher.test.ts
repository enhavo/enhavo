...
describe('Add and dispatch single event', () => {
    test('it should call the listener after same eventName is dispatched', () => {
    ...
    test('it should register several event names if passed', () => {
        let dispatcher = new FormEventDispatcher();
        let called = false;
        let form = new Form();
    ...
    test('it should not called of event listener was deleted', () => {
        let dispatcher = new FormEventDispatcher();
        let called = false;
        let form = new Form();
    ...
    test('it should not dispatch unless dispatcher is stopped', () => {
        let dispatcher = new FormEventDispatcher();
        let form = new Form();
        let called = false;
